subroutine selfEQ(kappa_UV_i,l_i,lb_i,kappa_UV,l,lb,rho0,mPion,mSigma,mf,Vtotal,fpi,h,Zphi,Zpsi,c,kappa)
...
!Inputing guess kappa_UV_i,l_i,lb_i, outputing kappa_UV,l,lb and other physical variables
  ...
  real(8) ZphiA(npoint1),ZpsiA(npoint1),cA(npoint1),kappaA(npoint1),etaphiA(npoint1),etapsiA(npoint1)
  ...
  do while((.not. stopp).and.(j < jmax))
    ...
    call FRG(kappa_UV_i,kappa_UV,rho0,mPion,mSigma,mf,Vall,fpi,h,Zphi,Zpsi,c,kappa)
    rho0k0=rho0
    Zphik0=Zphi
...
!interpolation
    ...
    do ii=1, npoint1
      ...
      call eta(kk,lam1k,lam2k,lam3k,lam4k,lam5k,lam0k,hk,Zphik,Zpsik,ck,kappak,etaphik,etapsik)
